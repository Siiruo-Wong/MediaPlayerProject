...
public class STabbedPaneUI extends BasicTabbedPaneUI {
    ...
    public STabbedPaneUI(String bgColorHex, String frontColorHex){
    	 this();
        setColor(bgColorHex,frontColorHex);
       
    }
    public STabbedPaneUI(Color bgColor, Color frontColor){
    	 this();
         setColor(bgColor,frontColor);
    }
  ...
  public static ComponentUI createUI(JComponent c) {
      return new STabbedPaneUI("#FFFFFF", "#FFFFFF");
  }
    ...
    public void setColor(Color bgColor, Color frontColor){
