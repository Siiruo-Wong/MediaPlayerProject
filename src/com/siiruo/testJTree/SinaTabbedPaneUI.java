...
public SinaTabbedPaneUI() {
  ...
  selectedColorSet.topGradColor1 =  new Color(0,255,0);//new Color(233, 237, 248);//选中的最上层
  selectedColorSet.topGradColor2 =  new Color(225,0,0);//new Color(158, 199, 240);//选中的第二层
  selectedColorSet.bottomGradColor1 = new Color(0,0,255);//new Color(112, 173, 239);//选中的第三层
...
protected void paintTabArea(Graphics g, int tabPlacement, int selectedIndex) {
   ...
   0,
   15, defaultColorSet.topGradColor2));
  // g2d.setColor(new Color(0,255,0,100));
   g2d.fillRect(0, 0, tabPane.getWidth(), 15);
  
   g2d.setPaint(new GradientPaint(0, 10,
   defaultColorSet.bottomGradColor1,
   0, 30, defaultColorSet.bottomGradColor2));
   g2d.fillRect(0, 15, tabPane.getWidth(), 16);
   ////////////////////////
  super.paintTabArea(g, tabPlacement, selectedIndex);
  if (contentTopBorderDrawn) {
   g2d.setColor(lineColor);
   //g2d.drawLine(0, 15, tabPane.getWidth() - 1,15);
  }
}
protected void paintTabBackground(Graphics g, int tabPlacement,
  ...
  if (contentTopBorderDrawn) {
   g2d.setColor(lineColor);
  // g2d.drawLine(rect.x, 15, rect.x + rect.width - 1, 15);
  }
}
