...
public SinaTabbedPaneUI() {
  ...
  selectedColorSet.topGradColor1 = new Color(102, 205, 170,50);//new Color(233, 237, 248);//选中的最上层
  selectedColorSet.topGradColor2 =  Color.WHITE;//new Color(158, 199, 240);//选中的第二层
  selectedColorSet.bottomGradColor1 = Color.WHITE;//new Color(112, 173, 239);//选中的第三层
  selectedColorSet.bottomGradColor2 = new Color(102, 205, 170);//new Color(183, 244, 253);//选中的最下层
  defaultColorSet = new ColorSet();
  defaultColorSet.topGradColor1 = Color.DARK_GRAY;//new Color(253, 253, 253);//未选的最上层
  defaultColorSet.topGradColor2 = Color.GRAY;//new Color(237, 237, 237);
  defaultColorSet.bottomGradColor1 = Color.WHITE;//new Color(222, 222, 222);
  defaultColorSet.bottomGradColor2 = Color.DARK_GRAY;//new Color(255, 255, 255);
  hoverColorSet = new ColorSet();
  hoverColorSet.topGradColor1 = new Color(0,255,0,30);//new Color(244, 244, 244);//鼠标在的时候最上层
  hoverColorSet.topGradColor2 =   Color.WHITE;//new Color(223, 223, 223);
  hoverColorSet.bottomGradColor1 = Color.WHITE;//new Color(211, 211, 211);
  hoverColorSet.bottomGradColor2 = new Color(0,255,0,30);//new Color(235, 235, 235);
  maxTabHeight = 21;
  setContentInsets(0);
}
...
protected void installDefaults() {
  ...
  tabInsets = new Insets(0, 0, 20, 20);
}
...
protected void paintTabArea(Graphics g, int tabPlacement, int selectedIndex) {
  Graphics2D g2d = (Graphics2D) g;
   ...
   g2d.fillRect(0, 10, tabPane.getWidth(), 10);
